...
The [Data Working Gup](http://ga4gh.org/#/) of the GA4GH developed [data model schemas](https://github.com/ga4gh/schemas) and application pgram interfaces (APIs) for genomic data.
